...
#---------------thesys-need-this-request-model-----------------------
...
async def chat(request:RequestObject):
    ...
    def generate():
        for token,_ in agent.stream(
            {
             "messages":[
                 SystemMessage("You are a stock price analysis assistant.You have ability to get real-time stock price,historical stock-price,news and balance sheet data on a given ticker symbol."),
